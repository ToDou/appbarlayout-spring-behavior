...
import static loopeer.com.appbarlayout_spring_extension.springbar.ViewUtils.objectEquals;
 ...
 */
@CoordinatorLayout.DefaultBehavior(AppBarLayoutSpring.Behavior.class)
public class AppBarLayoutSpring extends LinearLayout {
    ...
    /**
     * Interface definition for a callback to be invoked when an {@link AppBarLayoutSpring}'s vertical
     * offset changes.
     */
    public interface OnOffsetChangedListener {
        /**
         * Called when the {@link AppBarLayoutSpring}'s layout offset has been changed. This allows
         * child views to implement custom behavior based on the offset (for instance pinning a
         * view at a certain y value).
         *
         * @param appBarLayout   the {@link AppBarLayoutSpring} which offset has changed
         * @param verticalOffset the vertical offset for the parent {@link AppBarLayoutSpring}, in px
         */
        void onOffsetChanged(AppBarLayoutSpring appBarLayout, int verticalOffset);
    }
    ...
    public AppBarLayoutSpring(Context context) {
        this(context, null);
    }

    public AppBarLayoutSpring(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    /**
     * Add a listener that will be called when the offset of this {@link AppBarLayoutSpring} changes.
     *
    ...
    /**
     * Sets whether this {@link AppBarLayoutSpring} is expanded or not, animating if it has already
     * been laid out.
     * <p>
     * <p>As with {@link AppBarLayoutSpring}'s scrolling, this method relies on this layout being a
    ...
    /**
     * Sets whether this {@link AppBarLayoutSpring} is expanded or not.
     * <p>
     * <p>As with {@link AppBarLayoutSpring}'s scrolling, this method relies on this layout being a
     * direct child of a {@link CoordinatorLayout}.</p>
     *
    ...
    /**
     * The default {@link Behavior} for {@link AppBarLayoutSpring}. Implements the necessary nested
     * scroll handling with offsetting.
     */
    public static class Behavior extends HeaderBehavior<AppBarLayoutSpring> {
        private static final int MAX_OFFSET_ANIMATION_DURATION = 600; // ms
        private static final int INVALID_POSITION = -1;

        /**
         * Callback to allow control over any {@link AppBarLayoutSpring} dragging.
         */
        public static abstract class DragCallback {
            /**
             * Allows control over whether the given {@link AppBarLayoutSpring} can be dragged or not.
             * <p>
             ...
             * if not.
             */
            public abstract boolean canDrag(@NonNull AppBarLayoutSpring appBarLayout);
        }
        ...
        @Override
        public boolean onStartNestedScroll(CoordinatorLayout parent, AppBarLayoutSpring child,
        ...
        @Override
        public void onNestedPreScroll(CoordinatorLayout coordinatorLayout, AppBarLayoutSpring child,
        ...
        @Override
        public void onNestedScroll(CoordinatorLayout coordinatorLayout, AppBarLayoutSpring child,
        ...
        @Override
        public void onStopNestedScroll(CoordinatorLayout coordinatorLayout, AppBarLayoutSpring abl,
                                       View target) {
            if (!mWasNestedFlung) {
        ...
        private void checkShouldSpringRecover(CoordinatorLayout coordinatorLayout, AppBarLayoutSpring abl) {
            if (mOffsetSpring > 0) animateRecoverBySpring(coordinatorLayout, abl);
        }

        private void animateRecoverBySpring(final CoordinatorLayout coordinatorLayout, final AppBarLayoutSpring abl) {
            /*if (mOffsetSpring == 0 || abl.getHeight() <= mPreHeadHeight) return;*/
        ...
        public boolean onNestedFling(final CoordinatorLayout coordinatorLayout,
                                     final AppBarLayoutSpring child, View target, float velocityX, float velocityY,
                                     boolean consumed) {
            boolean flung = false;
        ...
        /**
         * Set a callback to control any {@link AppBarLayoutSpring} dragging.
         *
        ...
        private void animateOffsetTo(final CoordinatorLayout coordinatorLayout,
                                     final AppBarLayoutSpring child, final int offset, float velocity) {
        ...
        private void animateOffsetWithDuration(final CoordinatorLayout coordinatorLayout,
                                               final AppBarLayoutSpring child, final int offset, final int duration) {
        ...
        private int getChildIndexOnOffset(AppBarLayoutSpring abl, final int offset) {
        ...
        private void snapToChildIfNeeded(CoordinatorLayout coordinatorLayout, AppBarLayoutSpring abl) {
        ...
        @Override
        public boolean onMeasureChild(CoordinatorLayout parent, AppBarLayoutSpring child,
            ...
            if (mPreHeadHeight == 0 && child.getHeight() != 0) {
                mPreHeadHeight = child.getHeaderExpandedHeight();
            }
        ...
        @Override
        public boolean onLayoutChild(CoordinatorLayout parent, AppBarLayoutSpring abl,
                                     int layoutDirection) {
        ...
        @Override
        boolean canDragView(AppBarLayoutSpring view) {
        ...
        @Override
        void onFlingFinished(CoordinatorLayout parent, AppBarLayoutSpring layout) {
        ...
        @Override
        int getMaxDragOffset(AppBarLayoutSpring view) {
            return -view.getDownNestedScrollRange();
        }

        @Override
        int getScrollRangeForDragFling(AppBarLayoutSpring view) {
            return view.getTotalScrollRange();
        }

        @Override
        int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout,
                                     AppBarLayoutSpring appBarLayout, int newOffset, int minOffset, int maxOffset) {
        ...
        private int interpolateOffset(AppBarLayoutSpring layout, final int offset) {
            final int absOffset = Math.abs(offset);

            for (int i = 0, z = layout.getChildCount(); i < z; i++) {
                final View child = layout.getChildAt(i);
                final AppBarLayoutSpring.LayoutParams childLp = (LayoutParams) child.getLayoutParams();
                final Interpolator interpolator = childLp.getScrollInterpolator();
        ...
        private void updateAppBarLayoutDrawableState(final CoordinatorLayout parent,
                                                     final AppBarLayoutSpring layout, final int offset, final int direction) {
        ...
        private boolean shouldJumpElevationState(CoordinatorLayout parent, AppBarLayoutSpring layout) {
        ...
        private static View getAppBarChildOnOffset(final AppBarLayoutSpring layout, final int offset) {
            final int absOffset = Math.abs(offset);
            for (int i = 0, z = layout.getChildCount(); i < z; i++) {
                final View child = layout.getChildAt(i);
                if (absOffset >= child.getTop() && absOffset <= child.getBottom()) {
        ...
        @Override
        public Parcelable onSaveInstanceState(CoordinatorLayout parent, AppBarLayoutSpring appBarLayout) {
        ...
        @Override
        public void onRestoreInstanceState(CoordinatorLayout parent, AppBarLayoutSpring appBarLayout,
                                           Parcelable state) {
     ...
     * nested scrolling to automatically scroll any {@link AppBarLayoutSpring} siblings.
     */
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public boolean layoutDependsOn(CoordinatorLayout parent, View child, View dependency) {
            ...
            return dependency instanceof AppBarLayoutSpring;
        }
        ...
        public boolean onRequestChildRectangleOnScreen(CoordinatorLayout parent, View child,
            ...
            final AppBarLayoutSpring header = findFirstDependency(parent.getDependencies(child));
            if (header != null) {
        ...
        float getOverlapRatioForOffset(final View header) {
            if (header instanceof AppBarLayoutSpring) {
                final AppBarLayoutSpring abl = (AppBarLayoutSpring) header;
        ...
        private static int getAppBarLayoutOffset(AppBarLayoutSpring abl) {
            final CoordinatorLayout.Behavior behavior =
        ...
        @Override
        AppBarLayoutSpring findFirstDependency(List<View> views) {
            for (int i = 0, z = views.size(); i < z; i++) {
                View view = views.get(i);
                if (view instanceof AppBarLayoutSpring) {
                    return (AppBarLayoutSpring) view;
                }
            }
            return null;
        }
        ...
        int getScrollRange(View v) {
            if (v instanceof AppBarLayoutSpring) {
                return ((AppBarLayoutSpring) v).getTotalScrollRange();
            } else {
