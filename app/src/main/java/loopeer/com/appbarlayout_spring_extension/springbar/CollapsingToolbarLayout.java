...
import static loopeer.com.appbarlayout_spring_extension.springbar.MathUtils.constrain;
...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    private AppBarLayoutSpring.OnOffsetChangedListener mOnOffsetChangedListener;
    ...
    protected void onAttachedToWindow() {
        ...
        if (parent instanceof AppBarLayoutSpring) {
            ...
            ((AppBarLayoutSpring) parent).addOnOffsetChangedListener(mOnOffsetChangedListener);
    ...
    protected void onDetachedFromWindow() {
        ...
        final ViewParent parent = getParent();
        if (mOnOffsetChangedListener != null && parent instanceof AppBarLayoutSpring) {
            ((AppBarLayoutSpring) parent).removeOnOffsetChangedListener(mOnOffsetChangedListener);
        }
    ...
    private class OffsetUpdateListener implements AppBarLayoutSpring.OnOffsetChangedListener {
        OffsetUpdateListener() {
        }

        @Override
        public void onOffsetChanged(AppBarLayoutSpring layout, int verticalOffset) {
